...
public class AccountServiceImpl implements AccountService {
    ...
    */
    ...
    // ==============================[251009] 대표계좌 및 나머지 계좌 조회  ==============================
    @Override
    @Transactional(readOnly = true)
    public List<AccountResponse> getMainAccounts(String memberId) {
        return accountMapper.selectMainAccounts(memberId)
    ...
    @Override
    @Transactional(readOnly = true)
    public List<AccountResponse> getSubAccounts(String memberId) {
        return accountMapper.selectSubAccounts(memberId)
                .stream().map(this::toResp)
                .collect(Collectors.toList());
    }
