...
----------------------------------------------------------
-- [251016] 게시판 첨부파일 경로 컬럼 추가
----------------------------------------------------------
ALTER TABLE board_tbl ADD board_file_path VARCHAR2(300);
COMMENT ON COLUMN board_tbl.board_file_path IS '게시판 첨부파일 경로(썸네일/문서 등)';
