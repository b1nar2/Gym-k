...
public class CommentsController {
    ...
    public ResponseEntity<Long> createCommentstest(
    	...
    	// [251020] 로그 기록
    	log.info("댓글 등록 여부 게시글ID: ", postId);
    	log.info("댓글 등록 여부 댓글내용: ", commentContent);
    	
        return ResponseEntity.ok(999L); // 생성된 댓글ID 반환
    }
