...
// ✅ [251015 추가] 게시판관리 화면 import
import Boards from "./pages/cms/board/Boards"; // 게시판관리 페이지 import
//import BoardRegister from "./pages/cms/board/BoardRegister"; // 게시판 등록 페이지 import
//import BoardEdit from "./pages/cms/board/BoardEdit"; // 게시판 수정 페이지 import
import BoardForm from "./pages/cms/board/BoardForm"; // 게시판 등록/수정 페이지 import

// ✅ [251017 추가] 게시글 관리 화면 import
import CmsPostList from "./pages/cms/board/posts/CmsPostList"; // 게시글 목록
import CmsPostDetail from "./pages/cms/board/posts/CmsPostDetail"; // 게시글 상세보기
import CmsPostForm from "./pages/cms/board/posts/CmsPostForm"; // 게시글 등록/수정
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/cms/*" element={<CmsLayout />}>
          ...
          {/* [251015 추가] 게시판 관리 라우트 */}
          <Route path="boards" element={<Boards />} />                {/* 목록 */}
          {/* <Route path="boards/register" element={<BoardRegister />} />  */}
          {/* 등록 */}
          {/* <Route path="boards/edit/:boardId" element={<BoardEdit />} /> */}
          {/* 수정 */}
          <Route path="boards/form" element={<BoardForm />} />        {/* 등록 */}
          <Route path="boards/form/:boardId" element={<BoardForm />} /> {/* 수정 */}


          {/* ✅ [251017 추가] 게시글 관리 라우트 */}
          <Route path="boards/:boardId/posts" element={<CmsPostList />} />           {/* 목록 */}
          <Route path="boards/:boardId/posts/:postId" element={<CmsPostDetail />} /> {/* 상세 */}
          <Route path="boards/:boardId/posts/form" element={<CmsPostForm />} /> {/* 등록 */}
          <Route path="boards/:boardId/posts/:postId/edit" element={<CmsPostForm />} /> {/* 수정 */}
