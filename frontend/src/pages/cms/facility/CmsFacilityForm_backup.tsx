    ...
    <div className="p-8">
      ...
      <form onSubmit={handleSubmit} className="form-container">
        ...
        <div>
          ...
          <textarea name="facilityContent" value={form.facilityContent} onChange={handleChange} rows={4} className="form-input" />
        </div>
        ...
        <div>
          ...
          {form.facilityImagePath && (
            <p className="text-sm text-gray-600 mt-1">업로드된 경로: <span className="font-mono">{form.facilityImagePath}</span></p>
          )}
        </div>
        ...
        <div className="relative">
          ...
          <div className="flex gap-2">
            <input type="text" name="instructorName" value={form.instructorName || ""} readOnly className="form-input" placeholder="담당 강사를 선택하세요" />
            <button type="button" onClick={() => setShowPopup(true)} className="button-secondary">선택</button>
          </div>
          {showPopup && (
