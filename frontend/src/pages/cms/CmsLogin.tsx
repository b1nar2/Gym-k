...
export default function CmsLogin() {
  ...
  // [6] JSX(화면 구성)
  return (
    //<div className="flex items-center justify-center h-screen bg-gray-200"> // OLD
    <div className="form-container"> {/* //! [251025] 수정안 */}
      {/* [6-1] 로그인 박스 전체: form.css의 .form-container 사용 X */}
      <div className="form-box">
        {/* [6-2] 제목 //! [251025] h2 → h1 으로 변경함 */}
        <h1 className="form-title text-center">
          관리자 로그인
        </h1>

        {/* [6-3] 로그인 폼 */}
        {/* <form onSubmit={handleLogin}> */} {/* OLD */}
        <form onSubmit={handleLogin} className="space-y-4"> {/* //! [251025] 클래스 space-y-4 추가함*/}
          {/* [6-4] 관리자 ID 입력란 */}
          {/* <div style={{ marginBottom: 16 }}> */}
          <div> {/* //! [251025] 인라인 제거하고 위의 space-y-4 반영함*/}
          ...
          <button
            ...
            className="primary-button-style w-full mt-8" // primary-button-style로 변경, w-full, mt-8 추가하여 CmsUserForm과 유사한 버튼 스타일 구현 
