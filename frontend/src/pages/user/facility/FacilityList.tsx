...
interface Facility {
  ...
  facilityUse:boolean;       // ! 251025 사용여부 추가
}
...
export default function FacilityList() {
  ...
  const loadFacilities = async () => {
    try {
      ...
      ({ name, facilityType, page, size: 10, facilityUse: true }); // facilityUse?: boolean; 추가 
      // ../../../api/facilityApi에서도 facilityUse?: boolean; // 251025 사용여부 추가
